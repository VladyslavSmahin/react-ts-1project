...
const MeshGroup = ({ scene, camera, canvas }) => {
    ...
    useEffect(() => {
        ...
        const textures = [
            textureLoader.load('/textures/fire/color.jpg', undefined, undefined, (error) => console.error('Error loading fire texture:', error)),
            textureLoader.load('/textures/water/color.jpg', undefined, undefined, (error) => console.error('Error loading water texture:', error)),
            textureLoader.load('/textures/earth/color.jpg', undefined, undefined, (error) => console.error('Error loading earth texture:', error)),
        ];
    ...
    return (_jsx("div", { children: _jsx(Controls, { camera: camera, canvas: canvas, objectsRef: objectsRef, scene: scene, createFiguresCube: createFiguresCube, initialPositionsRef: initialPositionsRef }) }));
};
